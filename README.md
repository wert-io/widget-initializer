...
| **network**                                                                                                                                                                                                                                      |           optional           | *String*  |        `bitcoin`         | [List of supported currencies](https://docs.wert.io/docs/supported-coins-and-blockchains) | Network that will be selected for default commodity.                                                                                                                                                                                                                                                                                  |
