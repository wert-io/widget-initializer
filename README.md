...
| **isWarrantyDisabled**                                                                                                                                                                                                                           |           optional           | *Boolean* |         `false`          |                                       `true, false`                                       | Allows to disable NFT warranty option for specific widget mount, even if it is enabled for your partnerId and smart contract.                                                                                                                                                                                                         |
| **isCryptoHidden**                                                                                                                                                                                                                               |           optional           | *Boolean* |         `false`          |                                       `true, false`                                       | Allows to hide crypto mentions and exchange rate for NFT purchases if it is enabled for your partnerId.                                                                                                                                                                                                                               |
...
| **restrict_inputs**                                                                                                                                                                                                                              |           optional           | *Boolean* |         `false`          |                                       `true, false`                                       | Restrict to change currency input field, commodity input field and Wallet address field for the user for crypto purchases                                                                                                                                                                                                             |
