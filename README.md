...
| **commodity**                                                                                                                                                                                                                                    |           optional           | *String*  |          `BTC`           | [List of supported currencies](https://docs.wert.io/docs/supported-coins-and-blockchains) | Default commodity that will be selected in the module.                                                                                                                                                                                                                                                                                |
| **network**                                                                                                        <br/>                                                                                                                         |           optional           | *String*  |        `bitcoin`         | [List of supported currencies](https://docs.wert.io/docs/supported-coins-and-blockchains) | Network that will be selected for default commodity.                                                                                                                                                                                                                                                                                  |
| **commodities**                                                                                                                                                                                                                                  |           optional           | *String*  |                          | [List of supported currencies](https://docs.wert.io/docs/supported-coins-and-blockchains) | Commodities that will be available in the module. By default, all commodities are present. Should contain a stringified JSON of an array of objects with commodity and network fields. Fields are filled with the same values as a default commodity and network, e.g. `JSON.stringify([{ commodity: 'USDC', network: 'ethereum' }])` | |
...
| **skip_init_navigation**                                                                                                                                                                                                                         |           optional           | *Boolean* |         `false`          |                                       `true, false`                                       | By default, module will try to provide the closest to purchase starting route depending on provided parameters. If 'true', this navigation logic will be skipped.<br/><br/>*Please note that any value passed to the property with the boolean type will be considered as `true`. <br/> Example: `skip_init_navigation: "test"` will be equal to `skip_init_navigation: true`*                                                                                                                                                                     |
| **isWarrantyDisabled**                                                                                                                                                                                                                           |           optional           | *Boolean* |         `false`          |                                       `true, false`                                       | Allows to disable NFT warranty option for specific widget mount, even if it is enabled for your partnerId and smart contract.<br/><br/>*Please note that any value passed to the property with the boolean type will be considered as `true`. <br/> Example: `isWarrantyDisabled: "test"` will be equal to `isWarrantyDisabled: true`*                                                                                                                                                                                                         |
| **isCryptoHidden**                                                                                                                                                                                                                               |           optional           | *Boolean* |         `false`          |                                       `true, false`                                       | Allows to hide crypto mentions and exchange rate for NFT purchases if it is enabled for your partnerId.<br/><br/>*Please note that any value passed to the property with the boolean type will be considered as `true`. <br/> Example: `isCryptoHidden: "test"` will be equal to `isCryptoHidden: true`*                                                                                                                                                                                                                               |
...
| **state_of_residence**                                                                                                                                                                                                                           |           optional           | *String*  |                          |                                     code of USA state                                     | User's state of residence (for USA)                                                                                                                                                                                                                                                                                                   |
