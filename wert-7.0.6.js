  ...
  var WertWidget = /*#__PURE__*/function () {
    ...
    _createClass(WertWidget, [{
      ...
      value: function getParametersString() {
        var _a = this.options,
            payment_method = _a.payment_method,
            restOptions = __rest(_a, ["payment_method"]);

        var normalizedPaymentMethod = Array.isArray(payment_method) ? JSON.stringify(payment_method) : payment_method;
        return Object.entries(Object.assign(Object.assign(Object.assign({}, restOptions), {
